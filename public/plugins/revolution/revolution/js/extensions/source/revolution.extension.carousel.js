...
(function ($) {
  ...
  jQuery.extend(true, _R, {
    ...
    prepareCarousal: function (opt, a, direction, speed) {
      ...
      direction = opt.carousal.lastdirection = dircheck(
        direction,
        opt.carousal.lastdirection
      );
      ...
      if (speed !== undefined) {
        ...
        if (a == undefined) _R.carousalToEvalPosition(opt, direction);
        else animateCarousal(opt, direction, false);
      }
    },
