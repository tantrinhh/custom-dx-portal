...
!(function (a) {
  ...
  var b = jQuery.fn.revolution,
    c = {
      alias: "Carousal Min JS",
      name: "revolution.extensions.carousal.min.js",
      min_core: "5.3.0",
      version: "1.2.1",
    };
  jQuery.extend(!0, b, {
    prepareCarousal: function (a, d, h, i) {
      return (
        "stop" !== b.compare_version(c).check &&
        ((h = a.carousal.lastdirection = f(h, a.carousal.lastdirection)),
        e(a),
        (a.carousal.slide_offset_target = j(a)),
        void (void 0 !== i
          ? g(a, h, !1, 0)
          : void 0 == d
          ? b.carousalToEvalPosition(a, h)
          : g(a, h, !1)))
      );
    },
    carousalToEvalPosition: function (a, c) {
      var d = a.carousal;
      ...
      (j =
        ...
        0 !== Math.abs(d.slide_offset_target)
          ? g(a, c, !0)
          : b.organiseCarousal(a, c);
    },
    organiseCarousal: function (a, b, c, d) {
      b =
        void 0 === b ||
        "down" == b ||
        "up" == b ||
  ...
  var d = function (a) {
      ...
      (b.infbackup = b.infinity),
        ...
        (b.slide_offset = 0),
        (b.wrap = a.c.find(".tp-carousal-wrapper")),
    ...
    startKenBurn: function (a, d, e) {
      ...
      var f = a.data(),
        ...
        j =
          (f.owidth,
          f.oheight,
          "carousal" === d.sliderType ? d.carousal.slide_width : d.ul.width()),
        k = d.ul.height();
      if (
  ...
  jQuery.extend(!0, A, {
      ...
      null != a &&
        ...
        (1 == n || "true" == n || "on" == n || "1sttime" == n || r
          ? (("carousal" !== t.sliderType ||
              ("carousal" === t.sliderType &&
                "on" === t.carousal.showLayersAllTime &&
      ...
      void 0 !== a &&
        ...
        jQuery.each(p.layers[a], function (e, t) {
          ...
          A.updateMarkup(this, p),
            ...
            n &&
              "carousal" === p.sliderType &&
              "on" === p.carousal.showLayersAllTime &&
              A.animcompleted(i, p);
        }),
        p.layers.static &&
    ...
    prepareSingleCaption: function (e) {
      ...
      if ("slide" === i._ba) (e.offsetx = 0), (e.offsety = 0);
        ...
        i._isstatic &&
        void 0 !== a.carousal &&
        void 0 !== a.carousal.horizontal_align &&
        "carousal" === a.sliderType
      ) {
        switch (a.carousal.horizontal_align) {
          case "center":
    ...
    removeTheCaptions: function (e, i) {
      ...
      a &&
        jQuery.each(a, function (e) {
          var t = jQuery(this);
          "carousal" === i.sliderType && "on" === i.carousal.showLayersAllTime
  ...
  var e = function (a, b) {
    ...
    i = function (a, c) {
      if (
        ...
        "carousal" === c.navigation.mouseScrollNavigation
      ) {
        ...
        a.on("mousewheel DOMMouseScroll", function (f) {
          var h = g(f.originalEvent),
            ...
            m = !0;
          "carousal" == c.navigation.mouseScrollNavigation && (k = l = !1),
            -1 == j
              ? h.pixelY < d
                ? (k ||
                    ((c.sc_indicator = "arrow"),
    ...
    q = function (a, b, c) {
      ...
      b.rtl
        ...
        (b.padding_top = parseInt(c.carousal.padding_top || 0, 0)),
        (b.padding_bottom = parseInt(c.carousal.padding_bottom || 0, 0)),
        t(d, b.left, c),
        t(e, b.right, c),
        (b.left.opt = c),
        (b.right.opt = c),
    ...
    u = function (a, b, c, d) {
      ...
      "vertical" === b.direction
        ...
        (b.padding_top = parseInt(d.carousal.padding_top || 0, 0)),
        (b.padding_bottom = parseInt(d.carousal.padding_bottom || 0, 0)),
        (b.opt = d),
        ("outer-left" != b.position && "outer-right" != b.position) ||
          (d.outernav = !0),
    ...
    w = function (a, b, c, d, e) {
      ...
      if (
        ...
        "outer-top" === b.position
          ...
          ? a.after(l)
          : a.append(l),
          (b.padding_top = parseInt(e.carousal.padding_top || 0, 0)),
          (b.padding_bottom = parseInt(e.carousal.padding_bottom || 0, 0)),
          ("outer-left" != b.position && "outer-right" != b.position) ||
            (e.outernav = !0);
      }
      var m = c.data("index"),
