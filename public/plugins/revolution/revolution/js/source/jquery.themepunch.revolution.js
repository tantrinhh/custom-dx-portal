...
(function (jQuery, undefined) {
  ...
  var getNeededScripts = function (o, c) {
    ...
    if (!c.data("version") || !c.data("version").toString().match(/5./gi)) {
      ...
      // VIDEO EXTENSION
      if (o.sliderType == "carousal") n.carousal = true;
    ...
    if (n.carousal && typeof _R.prepareCarousal == "undefined")
      lAjax("revolution.extension.carousal", o);
    if (!n.carousal && typeof _R.animateSlide == "undefined")
  ...
  var waitForScripts = function (c, o) {
    ...
    if (
      ...
      (typeof punchgs !== "undefined" &&
        ...
        (!n.carousal ||
          (n.carousal && typeof _R.prepareCarousal !== "undefined")) &&
  ...
  var prepareOptions = function (container, opt) {
    opt.carousal.maxVisibleItems =
      opt.carousal.maxVisibleItems < 1 ? 999 : opt.carousal.maxVisibleItems; // === 1 ? 2 : opt.carousal.maxVisibleItems;
    opt.carousal.vertical_align =
      opt.carousal.vertical_align === "top"
        ? "0%"
        : opt.carousal.vertical_align === "bottom"
        ? "100%"
        : "50%";
  };
...
**************************************/
    ...
    if (!_R.resizeThumbsTabs || _R.resizeThumbsTabs(opt) === true) {
      ...
      if (opt.sliderType === "carousal" && opt.lastconw != opt.conw) {
        ...
        opt.pcartimer = setTimeout(function () {
          ...
          if (
            opt.sliderType == "carousal" &&
            opt.carousal.showLayersAllTime === "on"
          )
  ...
  var prepareSlides = function (container, opt) {
    ...
    if (opt.sliderType === "carousal") {
      ...
      opt.ul
        ...
        .wrap(
          '<div class="tp-carousal-wrapper" style="width:100%;height:100%;position:absolute;top:0px;left:0px;overflow:hidden;"></div>'
        );
      var apt =
  ...
  var swapSlide = function (container) {
    ...
    if (nextli.index() === -1 && opt.sliderType === "carousal")
