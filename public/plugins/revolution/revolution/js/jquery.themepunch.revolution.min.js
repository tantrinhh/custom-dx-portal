      ...
      return this.each(function () {
        ...
        if (
          ...
          (i.slideamount = i.slideamount - 1),
            ...
            i.carousal &&
              i.carousal.slides &&
              (i.carousal.slides = removeArray(i.carousal.slides, r)),
  ...
  jQuery.extend(!0, _R, {
    ...
    setSize: function (e) {
      var i = (e.top_outer || 0) + (e.bottom_outer || 0),
        t = parseInt(e.carousal.padding_top || 0, 0),
        a = parseInt(e.carousal.padding_bottom || 0, 0),
  ...
  var _ISM = _R.is_mobile(),
    ...
    getNeededScripts = function (t, e) {
      ...
      return (
        ...
        e.data("version") && e.data("version").toString().match(/5./gi)
          ? (e.find("img").each(function () {
            ...
            !i.videos &&
              ...
              (i.videos = !0),
            "carousal" == t.sliderType && (i.carousal = !0),
            ("off" !== t.parallax.type ||
              t.viewPort.enable ||
          ...
          : ((i.kenburns = !0),
            ...
            (i.layeranim = !0),
            (i.migration = !0)),
        "hero" == t.sliderType && ((i.carousal = !1), (i.navigation = !1)),
        ...
        i.carousal &&
          void 0 === _R.prepareCarousal &&
          lAjax("revolution.extension.carousal", t),
        i.carousal ||
    ...
    waitForScripts = function (e, i) {
      ...
      i.addons != undefined &&
        ...
        ("undefined" != typeof punchgs &&
          ...
          (!a.carousal || (a.carousal && void 0 !== _R.prepareCarousal)) &&
          ...
          (a.carousal || (!a.carousal && void 0 !== _R.animateSlide)))
    ...
    prepareOptions = function (e, i) {
      (i.carousal.maxVisibleItems =
        i.carousal.maxVisibleItems < 1 ? 999 : i.carousal.maxVisibleItems),
        (i.carousal.vertical_align =
          "top" === i.carousal.vertical_align
            ? "0%"
            : "bottom" === i.carousal.vertical_align
            ? "100%"
            : "50%");
    },
    ...
    runSlider = function (t, x) {
      ...
      if (
        ...
        (x.inviewport = !1),
          ...
          "carousal" === x.sliderType &&
            _R.prepareCarousal &&
            (punchgs.TweenLite.set(x.ul, { opacity: 0 }),
            _R.prepareCarousal(x, new punchgs.TimelineLite(), undefined, 0),
    ...
    containerResized = function (e, i) {
      if (
        ...
        if (
          ...
          contWidthManager(i),
          "carousal" == i.sliderType && _R.prepareCarousal(i, !0),
          e === undefined)
        )
          return !1;
        _R.setSize(i),
        ...
        removeSlots(e, i, e, 2),
          ...
          "carousal" === i.sliderType &&
            i.lastconw != i.conw &&
            (clearTimeout(i.pcartimer),
            (i.pcartimer = setTimeout(function () {
              _R.prepareCarousal(i, !0),
                "carousal" == i.sliderType &&
                  "on" === i.carousal.showLayersAllTime &&
    ...
    prepareSlides = function (e, u) {
      if (
        ...
        u.c.parent().prepend(i), u.c.parent().append(i), _R.prepareCarousal(u);
      }
          ...
          if ((e.attr("src", t.src), "img" == t.type))
            if (e.hasClass("defaultimg"))
              _R.isIE(8)
                ...
                : (-1 == t.src.indexOf("assets/images/transparent.png") &&
    ...
    swapSlideProgress = function (e, i) {
      ...
      if (
        ...
        (o.nextSlide = a.index()),
        "carousal" == o.sliderType)
      )
        (c = new punchgs.TimelineLite()),
          _R.prepareCarousal(o, c),
      ...
      _R.scrollHandling &&
        ...
        _R.animateTheCaptions
          ? "carousal" === o.sliderType && "on" === o.carousal.showLayersAllTime
            ? (jQuery.each(o.li, function (e) {
                o.carousal.allLayersStarted
                  ? _R.animateTheCaptions({
                      slide: jQuery(o.li[e]),
                      opt: o,
                      recall: !0,
